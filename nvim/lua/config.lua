...
set("", "<Leader>dd", "<cmd>Trouble diagnostics toggle filter.buf=0<CR>", nr)
set("", "<Leader>dw", "<cmd>Trouble diagnostics toggle<CR>", nr)
set("n", "<leader>dp", vim.diagnostic.goto_prev, nrsi)
set("n", "<leader>dn", vim.diagnostic.goto_next, nrsi)
set("n", "<leader>df", vim.diagnostic.open_float, nrsi)
