...
def main [config?] {
  check_base
  check_paru
  install_if_unavail [alacritty neovim nvim-packer-git alacritty tmux ttf-crimson-pro ttf nerd-fonts-inconsolata noto-fonts noto-fonts-emoji starship]
  ...
  if $config == null {
    echo 'install.nu (n)vim | (a)lacritty | (g)it | (f)ont | (y)olo'
  }
}
